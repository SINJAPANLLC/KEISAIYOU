...
export const emailLeads = pgTable("email_leads", {
  ...
  companyDomain: text("company_domain").unique(),
  fax: text("fax"),
  phone: text("phone"),
...
// A permanent, global do-not-contact list. Keep this separate from leads so a
// deleted lead can never be acquired or mailed again.
...
export const insertEmailLeadSchema = createInsertSchema(emailLeads).omit({ id: true, sentAt: true, sentSubject: true, sendClaimedAt: true, createdAt: true });
...
export const jobListings = pgTable("job_listings", {
  ...
  requiresBlackNumber: boolean("requires_black_number").default(false),
  requiresVehicle: boolean("requires_vehicle").default(false),
