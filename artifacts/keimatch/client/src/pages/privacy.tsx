    ...
    <div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="mb-8 text-center">
          <p className="text-muted-foreground leading-relaxed">個人情報の取り扱いについて</p>
          <p className="mt-2 font-semibold">合同会社SIN JAPAN</p>
          <p className="text-muted-foreground leading-relaxed mt-4 text-left">
            当社はKEI SAIYOUサービス（以下「本サービス」といいます）の利用者の個人情報を管理するにあたっては細心の注意を払い、以下に掲げたとおりに取り扱います。
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section data-testid="section-privacy-5">
            ...
            <p className="text-muted-foreground leading-relaxed">
              当社は取得した情報をもとに仮名加工情報を作成し、当社サービスの改善および新サービスの開発のために利用することがあります。
            </p>
          </section>
          ...
          <section data-testid="section-privacy-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              当社は、取得した個人情報をもとに、個人との対応関係を排斥した統計情報を作成することがあります。統計情報については、当社は何ら制限なく利用することができるものとします。
            </p>
          </section>
          ...
          <section data-testid="section-privacy-7">
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              {[
                { title: "(1) 組織的安全管理措置", items: ["個人データの取り扱いに関する責任者を設置し、事故等の報告窓口を整備しています。", "個人データの棚卸しや個人データの取り扱いに関する内部監査を実施しています。"] },
                { title: "(2) 人的安全管理措置", items: ["全従業員向けに個人データの取り扱いに関する研修を実施しています。", "全従業員と個人データの取り扱いに関する覚書を交わしています。"] },
                { title: "(3) 物理的安全管理措置", items: ["個人データを扱う機器、電子媒体は盗難防止策および暗号化を実施しています。", "個人データを取り扱う執務室は入退出制限を実施しています。"] },
                { title: "(4) 技術的安全管理措置", items: ["個人データのアクセス制御を実施し、必要最小限の担当者のみが個人データにアクセスする体制を整備しています。", "個人データを取り扱う情報システムを不正アクセスなどから保護する仕組みを導入しています。"] },
              ].map((block) => (
                <div key={block.title}>
          ...
          <section data-testid="section-privacy-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              当社は、利用者の会員登録の場合や利用者がサービスを利用する場合、個人情報の開示、訂正、削除もしくは利用停止の求めに応じる場合など、個人を識別できる情報（氏名、電話番号、メールアドレス、パスワード等）により、本人であることを確認します。
            </p>
          </section>
          ...
          <section data-testid="section-privacy-9">
            ...
            <p className="text-muted-foreground leading-relaxed">
              当社は、プライバシーの保護、利便性の向上、広告の配信、および統計データの取得のため、Cookieを使用します。また、当社は、CookieやJavaScript等の技術を利用して、サイト内におけるユーザーの行動履歴を取得することがあります。
            </p>
          </section>
          ...
          <section data-testid="section-privacy-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              当社では、個人情報を適切に保護するための管理者として代表社員が担当いたしております。
            </p>
